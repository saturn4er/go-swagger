...
import (
	...
	"github.com/saturn4er/go-swagger/examples/tutorials/todo-list/server-complete/models"
	"github.com/saturn4er/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations"
	"github.com/saturn4er/go-swagger/examples/tutorials/todo-list/server-complete/restapi/operations/todos"
)
