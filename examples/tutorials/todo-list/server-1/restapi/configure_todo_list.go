...
import (
	...
	"github.com/saturn4er/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/saturn4er/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
