...
import (
	...
	"github.com/saturn4er/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/saturn4er/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
