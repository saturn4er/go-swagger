...
![Google api screenshot](https://github.com/saturn4er/go-swagger/blob/master/examples/oauth2/img/google-api.png)
...
[example_code]: https://github.com/saturn4er/go-swagger/blob/master/examples/oauth2/
