...
import (
	...
	"github.com/saturn4er/go-swagger/examples/composed-auth/restapi/operations"

	auth "github.com/saturn4er/go-swagger/examples/composed-auth/auth"
	models "github.com/saturn4er/go-swagger/examples/composed-auth/models"
)
