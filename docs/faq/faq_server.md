...
Originally from issue [#1085](https://github.com/saturn4er/go-swagger/issues/1085).
...
Originally from issue [#1036](https://github.com/saturn4er/go-swagger/issues/1036).
...
eg.: https://github.com/saturn4er/go-swagger/blob/master/examples/authentication/restapi/configure_auth_sample.go#L33
...
Originally from issue [#762](https://github.com/saturn4er/go-swagger/issues/762).
...
Originally from issue [#1005](https://github.com/saturn4er/go-swagger/issues/1005). *(comes with a sample main.go for spec composition)*.
...
Originally from issue [#661](https://github.com/saturn4er/go-swagger/issues/661).
...
https://github.com/saturn4er/go-swagger/blob/master/generator/templates.go#L61-L73
...
There is some documentation on the config file format here: https://github.com/saturn4er/go-swagger/blob/gen-layout-configfile/docs/use/template_layout.md
...
Originally from issue Originally from issue [#305](https://github.com/saturn4er/go-swagger/issues/305).
