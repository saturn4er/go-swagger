...
https://github.com/saturn4er/go-swagger/blob/master/fixtures/codegen/existing-model.yml#L84-L88
...
Further, for repetitive customization, you might be willing to customize the generator's templates. Like in [here](https://github.com/saturn4er/go-swagger/blob/master/generator/templates/schemavalidator.gotmpl)
for models, or in [here](https://github.com/saturn4er/go-swagger/blob/master/generator/templates/server/parameter.gotmpl) for inline parameters.

Originally from issues [#997](https://github.com/saturn4er/go-swagger/issues/997) and [#1334](https://github.com/saturn4er/go-swagger/issues/1334)
...
Originally from issue [#959](https://github.com/saturn4er/go-swagger/issues/959). (*more discussion on edge cases there*).
...
Originally from issue [#990](https://github.com/saturn4er/go-swagger/issues/990).
...
Originally from issue [#932](https://github.com/saturn4er/go-swagger/issues/932).
...
Originally from issue [#643](https://github.com/saturn4er/go-swagger/issues/643).

### Accessing the Default return value
_Use-Case_: I was wondering how I would get the default response from the client?

Note: see also [Access HTTP status code from client#597](https://github.com/saturn4er/go-swagger/issues/597). 
...
Originally from issue [#616](https://github.com/saturn4er/go-swagger/issues/616).
...
Originally from issue [#948](https://github.com/saturn4er/go-swagger/issues/948).
