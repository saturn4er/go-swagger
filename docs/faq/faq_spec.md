...
Originally from issue [#561](https://github.com/saturn4er/go-swagger/issues/561).
...
Originally from issue [#47](https://github.com/saturn4er/go-swagger/issues/47).
-->
<!-- Obsolete / Not helpfu
...
Originally from issue [#400](https://github.com/saturn4er/go-swagger/issues/400).
-->
