...
(you may search [past and current issues labelled as "question"](https://github.com/saturn4er/go-swagger/issues?q=is%3Aissue+label%3Aquestion)).
...
You may also find most recent questions on Github [here](https://github.com/saturn4er/go-swagger/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+label%3Aquestion).
